    ...
    <nav class="main-nav">
      ...
      <div class="nav-dropdown">
        ...
        <div class="nav-dropdown-menu" role="menu">
          ...
          <a href="konu-basliklari.html" class="navlink{konu_basliklari}" data-route="konu_basliklari" data-i18n="nav_konu_basliklari"></a>
          <a href="bildiri-formati.html" class="navlink{bildiri_formati}" data-route="bildiri_formati" data-i18n="nav_bildiri_formati"></a>
        </div>
      </div>
    ...
    <div class="footer-grid">
      ...
      <div>
        ...
        <ul>
          ...
          <li><a href="konu-basliklari.html" data-i18n="nav_konu_basliklari"></a></li>
          <li><a href="bildiri-formati.html" data-i18n="nav_bildiri_formati"></a></li>
        </ul>
      </div>
      <div>
...
PAGES = {
  ...
  'konu-basliklari': ('Konu Başlıkları — MolMed Congress 2026', 'konu_basliklari'),
  'bildiri-formati': ('Bildiri Formatı — MolMed Congress 2026', 'bildiri_formati'),
...
ROUTES = ['home','kongre','davet','kurullar','genel','konu_basliklari','bildiri_formati','program','bildiri','kayit','iletisim']
...
for name,(title,route) in PAGES.items():
    ...
    flags[route] = ' active'
    if route in ('davet','kurullar','genel','konu_basliklari','bildiri_formati'): flags['kongre'] = ' active'
