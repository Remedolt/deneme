...
<title>{title}</title>
<meta name="description" content="XI. International Congress of Molecular Medicine &amp; I. Multidisciplinary Wellness and Longevity Symposium — 24–27 December 2026, Istanbul Nişantaşı University.">
  ...
  <div class="container">
    <a href="index.html" class="brand" aria-label="MolMed Congress — Home">
      ...
      <span class="brand-text">
        ...
        <span>24–27 Aralık / December 2026</span>
      </span>
    </a>
    ...
    <nav class="main-nav">
      ...
      <div class="nav-dropdown">
        <button type="button" class="navlink navlink--dropdown{temalar}" data-dropdown-toggle aria-haspopup="true" aria-expanded="false">
          <span data-i18n="nav_temalar"></span>
          <svg class="chevron" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M6 9l6 6 6-6"/></svg>
        </button>
        <div class="nav-dropdown-menu" role="menu">
          <a href="konu-basliklari.html" class="navlink{konular}" data-route="konular" data-i18n="nav_konular"></a>
          <a href="bildiri-formati.html" class="navlink{format}" data-route="format" data-i18n="nav_format"></a>
        </div>
      </div>
...
<footer class="site-footer">
  <div class="container">
    <div class="footer-grid">
      ...
      <div>
        ...
        <ul>
          ...
          <li><a href="konu-basliklari.html" data-i18n="nav_konular"></a></li>
          <li><a href="bildiri-formati.html" data-i18n="nav_format"></a></li>
    ...
    <div class="footer-bottom">
      ...
      <a href="kvkk.html" data-i18n="footer_privacy"></a>
    </div>
  </div>
</footer>
...
PAGES = {
  ...
  'konu-basliklari': ('Konu Başlıkları — MolMed Congress 2026', 'konular'),
  'bildiri-formati': ('Bildiri Formatı — MolMed Congress 2026', 'format'),
  ...
  'kvkk': ('KVKK — MolMed Congress 2026', 'kvkk'),
}
ROUTES = ['home','kongre','temalar','konular','format','davet','kurullar','genel','program','bildiri','kayit','iletisim','kvkk']
...
for name,(title,route) in PAGES.items():
    ...
    if route in ('konular','format'): flags['temalar'] = ' active'
